...
if __name__ == "__main__":
    ...
    parser.add_argument('--format', dest="format", action="store", choices=["png", "pdf", "svg", "eps"], default="png")
    parser.add_argument('--output_file', dest="output_file", action="store", default="output.png")
    input_args = parser.parse_args()

    fig = plotchi(input_args.file, interpolate=input_args.interpolation, column=int(input_args.column))
    fig.savefig(input_args.output_file, format=input_args.format)
